...
int *Iec104_main(void *arg){
    ...
    printf("feilong:Iec104 Listen Ok(%d)\r\n", portnum);
    ...
    // while(1){
        ...
        printf("feilong:Waiting for connection\n");
        ...
        int feilongsocketfd = (*(int *)arg);
        Iec10x_Scheduled(feilongsocketfd);      
        Iec104_StateMachine();
...
int main(int argc, char *argv[]){
    ...
    addr1 =  inet_addr("0.0.0.0");
    addr2 =  inet_addr("0.0.0.0");
    uint32_t Addr = 0,i;
    void *ptemp = NULL;
