...
namespace Peach.Core.Test
{
	...
	class RunTests
	{
		...
		void e_IterationStarting(RunContext context, uint currentIteration, uint currentSubIteration, uint? totalIterations)
		{
...
<Peach>
	...
	<Test name='Default' faultWaitTime='0' replayEnabled='true'>
		...
		void r_IterationStarting(RunContext context, uint currentIteration, uint currentSubIteration, uint? totalIterations)
		{
